...
public class MainScreen_Activity extends AppCompatActivity {
    ...
    private void moveToAnotherActivity(Class<?> cls) {
        Intent intent = new Intent(MainScreen_Activity.this, cls);
        ...
        db.collection("users")
                ...
                .get().addOnCompleteListener(task -> {
                    ...
                    if (msg.equals("FALSE")) {
                        ...
                        dialog.dismiss();
                        Toast.makeText(MainScreen_Activity.this, getString(R.string.error_existedEmail), Toast.LENGTH_SHORT).show();
    ...
    public void signUpPage(View v) {
        Intent intent = new Intent(MainScreen_Activity.this,  PhoneSignupActivity.class);
        startActivity(intent);
    }

    public void signInPage(View v) {
        Intent intent = new Intent(MainScreen_Activity.this, SigninChoiceActivity.class);
        startActivity(intent);
    }
