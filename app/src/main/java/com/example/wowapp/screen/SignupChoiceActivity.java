...
public class SignupChoiceActivity extends AppCompatActivity implements  View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout llSignupPage = findViewById(R.id.llSignupPage);
...
/*
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                dialog.dismiss();
                Toast.makeText(SignupChoiceActivity.this, "Vaarifiaction falde", Toast.LENGTH_SHORT).show();
                setVisibleVisibility(llPhone.getId());
            }
            ...
            public void onCodeSent(@NonNull String verificationId,
                ...
                Toast.makeText(SignupChoiceActivity.this, "Code sent", Toast.LENGTH_SHORT).show();
 ...
 */
    ...
    //    if(v.getId() == btnOtp.getId()) {
      //      if(TextUtils.isEmpty(edtOtp.getText().toString()) || edtOtp.getText().toString().length() != 6) {
        //        Toast.makeText(SignupChoiceActivity.this, "Enter write code ", Toast.LENGTH_SHORT).show();
        //    }
           // else {
    ...
    private void signUp() {
        PhoneAuthOptions options =
                PhoneAuthOptions.newBuilder(mAuth)
                        ...
                        .setActivity(SignupChoiceActivity.this)                 // Activity (for callback binding)
                            ...
                            upload.putFile(avatarUri)
                                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                        ...
                                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                            ...
                                            Toast.makeText(SignupChoiceActivity.this, "Image Uploaded", Toast.LENGTH_SHORT).show();
                                        }
                                    })
                                    .addOnFailureListener(new OnFailureListener() {
                                        @Override
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(SignupChoiceActivity.this, "Image Failed", Toast.LENGTH_SHORT).show();
                                        }
                                    });
    ...
    private void moveToAnotherActivity(Class<?> cls) {
        Intent intent = new Intent(SignupChoiceActivity.this, cls);
    ...
    private void handleBtnPhoneClick() {
        ...
        String phone = edtPhone.getText().toString();
            ...
            dialog.show();
      String   formattedPhone= countryPicker.getSelectedCountryCodeWithPlus() + edtPhone.getText().toString();
        edtPhone.setText(formattedPhone);
            db.collection("users")
                    ...
                    .get().addOnCompleteListener(task -> {
                        ...
                        if (msg.equals("FALSE")) {
                            handler.post(SignupChoiceActivity.this::signUp);
                        } else {
                            dialog.dismiss();
                            Toast.makeText(SignupChoiceActivity.this, "False", Toast.LENGTH_SHORT).show();
                            setVisibleVisibility(llPhone.getId());
                        }
                    });
