...
import com.example.wowapp.screen.model.Validator;
...
public class PhoneSignupActivity extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                  dialog.dismiss();
                Toast.makeText(PhoneSignupActivity.this, "Veryfication Failed!", Toast.LENGTH_SHORT).show();
                setVisibleVisibility(llPhone.getId());
            }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == btnOtp.getId()) {
            if (TextUtils.isEmpty(edtOtp.getText().toString()) || edtOtp.getText().toString().length() != 6) {
                Toast.makeText(PhoneSignupActivity.this, "Please  enter write otp", Toast.LENGTH_SHORT).show();
            }
            else {
    ...
    private void handleBtnPhoneClick() {
        ...
        String countryCode = ccp.getSelectedCountryCode();
            ...
            dialog.show();
            String formattedPhone =  "+" + countryCode + phone;
